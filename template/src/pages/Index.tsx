  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center">
      <div className="text-center text-white">
        <h1 className="text-7xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-gray-400 bg-clip-text text-transparent">
          Dira-Tak-Builder
        </h1>
        ...
        <div className="relative">
          <div className="w-32 h-32 mx-auto relative">
            ...
            <div className="absolute inset-2 rounded-full border-4 border-gray-400/30 animate-spin" style={{animationDirection: 'reverse', animationDuration: '3s'}}></div>
